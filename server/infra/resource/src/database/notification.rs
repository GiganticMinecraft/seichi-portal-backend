...
use domain::{
    notification::models::{
        Notification, NotificationId, NotificationSettings, NotificationSource,
    },
    user::models::Role,
};
...
use crate::{
    ...
    dto::{
        NotificationDto, NotificationSettingsDto, NotificationSourceInformationDto,
        NotificationSourceTypeDto, UserDto,
    },
};
